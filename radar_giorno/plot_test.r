...
#infile="/home/meteo/radar_giorno/grads/cumulata_giorno_20140523.dat"
#data_evento="20140523"
...
test_prov$qu90<-qu90
test_prov$qu98<-qu98
qu50 <- round(test_prov@data$qu50,0)
qu75 <- round(test_prov@data$qu75,0)
qu90 <- round(test_prov@data$qu90,0)
qu98 <- round(test_prov@data$qu98,0)
...
lema<-read.table("/home/meteo/radar_giorno/tmp/lema.txt")
